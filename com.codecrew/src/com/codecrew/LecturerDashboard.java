...
import com.codecrew.LecturerProfileService;
import com.codecrew.ViewGPAForm;
import com.codecrew.ViewMarksForm;
import com.codecrew.UploadMarksForm;
import com.codecrew.NoticeForm;
import com.codecrew.TimetableForm;
...
public class LecturerDashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        try {
            jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/codecrew/fot-2.jpg"))); // NOI18N
        } catch (NullPointerException e) {
            jLabel2.setBackground(new java.awt.Color(200, 150, 100));
    ...
    private void btnAddMarksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddMarksActionPerformed
        UploadMarksForm uploadMarks = new UploadMarksForm();
